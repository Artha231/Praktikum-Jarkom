...
1. Buka browser dan unduh file alice.txt melalui URL berikut https://gaia.cs.umass.edu/wireshark-labs/TCP-wireshark-file1.html 
![Tampilan websitenya akan sperti ini.](../assets/image/file2.png)
 ![ Kemudian simpan file tersebut.](../assets/image/file2.png)
...
4. buka wireshark kembali dan ketik di bagian atas untuk nge filter http saja 
 ![Hasil Percobaan](../assets/image/file2.png)
  ![Hasil Percobaan](../assets/image/capture%20wireshark2.png)
...
![Hasil Percobaan](../assets/image/bukti%203.png)
![Hasil Percobaan](../assets/image/capture3.png)
...
![Hasil Percobaan](../assets/image/bukti%204.png)
![Hasil Percobaan](../assets/image/capture%204.png)
...
![Hasil Percobaan](../assets/image/capture%20benar.png) 
